...
public struct AnyBinaryInteger<Magnitude>: BinaryInteger where Magnitude: BinaryInteger, Magnitude.Magnitude == Magnitude {
...
public extension AnyBinaryInteger {
...
private extension AnyBinaryInteger {
